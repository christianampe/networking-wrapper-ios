...
protocol SteeringBoltProtocol {
    ...
    @discardableResult func request(_ request: URLRequest, completion: @escaping (Result<SteeringResponseProtocol, Error>) -> Void) -> URLSessionDataTask
}
